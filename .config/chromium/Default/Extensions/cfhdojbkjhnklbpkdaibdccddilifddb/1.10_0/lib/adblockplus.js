  ...
  window.URL = (function()
  {
    ...
    }))
    {
      ...
      URL = function(url, baseUrl)
      {
        ...
        anchor.href = url;
        for (var _loopIndex45 = 0; _loopIndex45 < URLProperties.length; ++_loopIndex45)
        {
          var prop = URLProperties[_loopIndex45];
...
require.scopes["whitelisting"] = (function()
{
  ...
  var getDecodedHostname = _tempVar46.getDecodedHostname;
  ...
  exports.processKey = function(token, page, frame)
  {
    ...
    var _tempVar47 = token.split("_", 2);
    var key = _tempVar47[0];
    var signature = _tempVar47[1];
    key = key.replace(/=/g, "");
...
require.scopes["filterValidation"] = (function()
{
  ...
  var InvalidFilter = _tempVar48.InvalidFilter;
  var ElemHideBase = _tempVar48.ElemHideBase;
  ...
  exports.parseFilters = function(text)
  {
    ...
    for (var i = 0; i < lines.length; i++)
    {
      var _tempVar49 = parseFilter(lines[i]);
      var filter = _tempVar49.filter;
      var error = _tempVar49.error;
      if (filter)
      {
        filters.push(filter);
      }
...
require.scopes["filterComposer"] = (function()
{
  ...
  var _tempVar51 = require("whitelisting");
  var getKey = _tempVar51.getKey;
  var isFrameWhitelisted = _tempVar51.isFrameWhitelisted;
  var defaultMatcher = require("matcher").defaultMatcher;
  var RegExpFilter = require("filterClasses").RegExpFilter;
  ...
  exports.composeFilters = function(details)
  {
    ...
    if (!isFrameWhitelisted(page, frame, RegExpFilter.typeMap.DOCUMENT))
    {
      ...
      for (var _loopIndex52 = 0; _loopIndex52 < details.urls.length; ++_loopIndex52)
      {
        var url = details.urls[_loopIndex52];
      ...
      if (filters.length == 0 && !isFrameWhitelisted(page, frame, RegExpFilter.typeMap.ELEMHIDE))
      {
        ...
        for (var _loopIndex53 = 0; _loopIndex53 < selectors.length; ++_loopIndex53)
        {
          var selector = selectors[_loopIndex53];
...
{
  var exports = {};
  var _tempVar54 = require("icon");
  var startIconAnimation = _tempVar54.startIconAnimation;
  var stopIconAnimation = _tempVar54.stopIconAnimation;
  var Utils = require("utils").Utils;
  ...
  function openNotificationLinks()
  {
    ...
    {
      for (var _loopIndex55 = 0; _loopIndex55 < activeNotification.links.length; ++_loopIndex55)
      {
        var link = activeNotification.links[_loopIndex55];
...
require.scopes["uninstall"] = (function()
{
  ...
  function setUninstallURL()
  {
    ...
    for (var _loopIndex56 = 0; _loopIndex56 < keys.length; ++_loopIndex56)
    {
      var key = keys[_loopIndex56];
